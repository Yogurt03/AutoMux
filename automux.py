...
def install():
    print("\n    [01]  Aircrack-ng" + colored(" * ","red"))
    print("    [02]  Bettercap" + colored(" * ","red"))
    print("    [03]  Cupp")
    print("    [04]  dnsmap")
    print("    [05]  Hydra")
    print("    [06]  hping3" + colored(" * ","red"))
    print("    [07]  HashBuster")
    print("    [08]  Lazymux")
    print("    [09]  Metasploit")
    print("    [10]  Nmap")
    print("    [11]  oh-my-zsh")
    print("    [12]  RED_HAWK")
    print("    [13]  RouterSploit")
    print("    [14]  sqlmap")
    print("    [15]  sslscan")
    print("    [16]  Slowloris")
    print("    [17]  SlowHTTPTest")    
    print("    [18]  WebCrack")
    print("    [19]  webdirscan\n")
    print("    [00]  Bcak Menu\n") 
    install = input(colored("AutoMux >>> ","yellow"))

    if install.strip() == "1" or install.strip() == "01":install_aircrack_ng()
    elif install.strip() == "2" or install.strip() == "02":install_bettercap()
    elif install.strip() == "3" or install.strip() == "03":install_Cupp()
    elif install.strip() == "4" or install.strip() == "04":install_dnsmap()
    elif install.strip() == "5" or install.strip() == "05":install_Hydra()
    elif install.strip() == "6" or install.strip() == "06":install_hping3()
    elif install.strip() == "7" or install.strip() == "07":install_HashBuster()
    elif install.strip() == "8" or install.strip() == "08":install_lazymux()
    elif install.strip() == "9" or install.strip() == "09":install_msf()
    elif install.strip() == "10":install_nmap()
    elif install.strip() == "11":install_zsh()
    elif install.strip() == "12":install_RED_HAWK()
    elif install.strip() == "13":install_RouterSploit()
    elif install.strip() == "14":install_sqlmap()
    elif install.strip() == "15":install_sslscan()
    elif install.strip() == "16":install_slowloris()
    elif install.strip() == "17":install_SlowHTTPTest()
    elif install.strip() == "18":install_WebCrack()
    elif install.strip() == "19":install_webdirscan()
